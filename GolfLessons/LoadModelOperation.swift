...
//  GCWApp
//
//  Created by Matthias Ziegler on 17.02.16.
//  Copyright © 2016 Matthias Ziegler Golfprofessional. All rights reserved.
//
...
class LoadModelOperation: Operation {
    ...
    override func execute() {
        ...
        */
        ...
        let storeURL = cachesFolder.URLByAppendingPathComponent("GolfLessons.sqlite")
